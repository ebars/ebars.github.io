...
if (getMobileOperatingSystem() === "Incompatible Device") {
    setTimeout(function() {
        $('#theloader').fadeOut(500, function() {
            $('#incompatibledevice').fadeIn(500, function() {});
        });
    }, 1500);
} else {
    setTimeout(function() {
        $('#theloader').fadeOut(500, function() {
            $('#compatibledevice').fadeIn(500, function() {});
        });
    }, 1500);
}
